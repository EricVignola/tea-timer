...
var _TeaView = __webpack_require__(37);

var _TeaView2 = _interopRequireDefault(_TeaView);

var _reactMotion = __webpack_require__(42);

var _teas = __webpack_require__(53);

var _teas2 = _interopRequireDefault(_teas);
...
var App = function (_React$Component) {
    ...
    _createClass(App, [{
        ...
        value: function render() {
            ...
            var teasIsLoaded = this.state.teasIsLoaded;
                        ...
                        _reactMotion.StaggeredMotion,
                        {
                            ...
                            styles: function styles(prevInterpolatedStyles) {
                                return prevInterpolatedStyles.map(function (_, i) {
                                    return i === 0 ? { transform: (0, _reactMotion.spring)(_this2.state.menuTarget) } : { transform: (0, _reactMotion.spring)(_this2.state.teaViewTarget) };
                                });
                            } },
                        function (interpolatingStyles) {
                            return _react2.default.createElement(
                                ...
                                interpolatingStyles.map(function (style, i) {
                                    if (i === 0) {
                                        return _react2.default.createElement(_Menu2.default, { teas: _this2.state.teas,
                                            getMenuChoice: _this2.selectComponent,
                                            toggle: _this2.clickHandler,
                                            doMount: _this2.state.renderMenu,
                                            key: i,
                                            style: { transform: 'translateX(' + style.transform + '%)' } });
                                    } else {
                                        return _react2.default.createElement(_TeaView2.default, { teas: _this2.state.teas,
                                            getMenuChoice: _this2.selectComponent,
                                            toggle: _this2.clickHandler,
                                            chosenTea: _this2.state.chosenTea,
                                            doMount: _this2.state.renderTeaView,
                                            key: i,
                                            style: { transform: 'translateX(' + style.transform + '%)' } });
                                    }
                                })
...
*/
var aa=__webpack_require__(1),l=__webpack_require__(17),B=__webpack_require__(4),C=__webpack_require__(2),ba=__webpack_require__(18),da=__webpack_require__(19),ea=__webpack_require__(20),fa=__webpack_require__(21),ia=__webpack_require__(22),D=__webpack_require__(6);
...
var _TeaListItem = __webpack_require__(36);

var _TeaListItem2 = _interopRequireDefault(_TeaListItem);
        ...
        value: function render() {
            ...
            var teaListItems = this.props.teas.map(function (tea) {
                return _react2.default.createElement(_TeaListItem2.default, { key: tea.type,
                    tea: tea,
                    getMenuChoice: _this2.props.getMenuChoice,
...
var TeaListItem = function (_React$Component) {
    _inherits(TeaListItem, _React$Component);

    function TeaListItem(props) {
        _classCallCheck(this, TeaListItem);

        return _possibleConstructorReturn(this, (TeaListItem.__proto__ || Object.getPrototypeOf(TeaListItem)).call(this, props));
    }

    _createClass(TeaListItem, [{
        key: "render",
        value: function render() {
            return _react2.default.createElement(
                "li",
...
var _TeaStats = __webpack_require__(39);

var _TeaStats2 = _interopRequireDefault(_TeaStats);

var _BackButton = __webpack_require__(40);

var _BackButton2 = _interopRequireDefault(_BackButton);

var _TeaViewTitle = __webpack_require__(41);

var _TeaViewTitle2 = _interopRequireDefault(_TeaViewTitle);
...
var TeaView = function (_React$Component) {
    _inherits(TeaView, _React$Component);

    function TeaView(props) {
        _classCallCheck(this, TeaView);
...
var TeaStats = function (_React$Component) {
    _inherits(TeaStats, _React$Component);

    function TeaStats(props) {
        _classCallCheck(this, TeaStats);

        return _possibleConstructorReturn(this, (TeaStats.__proto__ || Object.getPrototypeOf(TeaStats)).call(this, props));
    }
...
var BackButton = function (_React$Component) {
    ...
    _createClass(BackButton, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'button',
                { style: this.props.style, className: 'button large expanded', onClick: this.props.toggle },
                'Back To Tea Menu'
            );
        }
    }]);
...
var TeaViewTitle = function (_React$Component) {
    _inherits(TeaViewTitle, _React$Component);

    function TeaViewTitle(props) {
        _classCallCheck(this, TeaViewTitle);

        return _possibleConstructorReturn(this, (TeaViewTitle.__proto__ || Object.getPrototypeOf(TeaViewTitle)).call(this, props));
    }

    _createClass(TeaViewTitle, [{
        key: 'render',
        value: function render() {
            return _react2.default.createElement(
                'h1',
...
var _reorderKeys = __webpack_require__(52);
